        ...
        <nav className="navbar w-full flex relative top-0 h-20 bg-blue-500 px-4 items-center justify-between text-white z-50">
            ...
            <div className="links">
                <div className="flex items-center space-x-4">
                    ...
                    <Link to="/eventure/event" className="text-white px-4 py-2 rounded-full text-center">
                        Events</Link>
                    <Link to="/eventure/event/task" className="text-white px-4 py-2 rounded-full text-center">Tasks</Link>
                    <Link to="/eventure/user/:user_id" className="text-white px-4 py-2 rounded-full text-center">Profile</Link>
